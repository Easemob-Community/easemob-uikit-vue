 ...
 *
 * 用法（P1 Step 4 起脚本归 core 维护，argv[2] 可指定包根，默认 core 自身）：
 *   node packages/uikit-core/scripts/generate-fluent-emoji-map.mjs
 */
...
const PICKER = resolve(pkgRoot, 'src/components/emoji-picker/emoji-picker.vue')
const OUT = resolve(pkgRoot, 'src/components/emoji-picker/fluent-emoji-map.ts')
