...
const messages: LocaleMessages = {
  ...
  'contact.inviteTitle': 'Friend Requests',
  'contact.inviteEmpty': 'No friend requests',
  ...
  'contact.inviteAcceptFailed': 'Failed to accept request',
  'contact.inviteDeclineFailed': 'Failed to decline request',
