...
| prefixIcon   | `string`                                                      | —               | 前缀图标名称，格式 "category/icon-name"，如 "search"                                                                                                                                                    |
| clearable    | `boolean`                                                     | `false`         | 是否显示清除按钮（有输入内容时右侧出现）。<br>默认清除图标为 `xmark/light`，搜索场景可传 `clear-icon="search/xmark"`。                                                                                                           |
| clearIcon    | `string`                                                      | `'xmark/light'` | 清除按钮图标名称，默认 "xmark/light"                                                                                                                                                                    |
| error        | `boolean`                                                     | `false`         | 是否处于错误状态；为 true 时边框变红并显示错误图标                                                                                                                                                                 |
| errorMessage | `string`                                                      | `''`            | 错误提示文案；传入时显示在输入框下方                                                                                                                                                                           |
| errorIcon    | `string`                                                      | `'status/info'` | 错误图标名称，默认 "status/info"                                                                                                                                                                      |
| readonly     | `boolean`                                                     | `false`         | 是否只读；只读时背景置灰但文字仍可选中复制                                                                                                                                                                        |
