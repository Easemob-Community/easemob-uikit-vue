...
- [ ] Phase 1：P1-1 文档准确性
- [ ] Phase 1：P1-2 focus-visible
- [ ] Phase 1：P1-3 触摸热区
- [ ] Phase 1：P1-4 Input error
- [ ] Phase 1：P1-5 暗色对比度
- [ ] Phase 2：P2-1 Modal danger
- [ ] Phase 2：P2-2 Toast 补全
- [ ] Phase 2：P2-3 Skeleton
- [ ] Phase 2：P2-4 空状态模板
- [ ] Phase 2：P2-5 图标 color 复核
- [ ] Phase 3：P3-1 间距阶梯
- [ ] Phase 3：P3-2 Type Scale
- [ ] Phase 3：P3-3 Token/图标总览页
- [ ] Phase 3：P3-4 z-index 层级表
- [ ] Phase 4：P4-1 动效可视化
- [ ] Phase 4：P4-2 手势/断点
- [ ] Phase 4：P4-3 Do/Don't + 设计原则
- [ ] Phase 4：P4-4 其余 P2 项（按需）
